...
export default function Home() {
  return (
    <section className="relative grid gap-12 md:gap-8 lg:grid-cols-[1fr_400px] items-center py-10 md:py-20 animate-in fade-in duration-700">
      ...
      <div className="flex flex-col z-10">
        <div className="space-y-4">
          <div className="inline-flex items-center rounded-full border border-violet-500/30 bg-violet-500/10 px-3 py-1 text-sm text-violet-300 backdrop-blur-sm w-fit mb-2">
          ...
          <h2 className="text-2xl md:text-3xl text-gray-300 font-medium font-['Outfit']">
            {profile.role}
          </h2>
        ...
        <div className="mt-10 flex flex-wrap items-center gap-4">
          <Link 
            to="/projects" 
            className="group relative inline-flex items-center justify-center gap-2 bg-violet-600 hover:bg-violet-500 text-white px-8 py-3.5 rounded-full font-medium transition-all duration-300 shadow-[0_0_20px_rgba(139,92,246,0.25)] hover:shadow-[0_0_30px_rgba(139,92,246,0.4)] hover:-translate-y-0.5"
          >
          ...
          <Link 
            to="/contact" 
            className="px-8 py-3.5 rounded-full font-medium text-gray-300 border border-white/10 hover:bg-white/5 transition-colors backdrop-blur-sm"
          >
            Me contacter
          </Link>
        </div>
